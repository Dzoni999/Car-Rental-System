...
namespace carrental
{
    public partial class rental : Form
    {
        ...
        //  SqlConnection con = new SqlConnection("Data Source=DESKTOP-59GMICN; Initial Catalog=carrental;Integrated Security = True;");
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["CarRentalDB"].ConnectionString);
        SqlCommand cmd;
        SqlCommand cmd1;
        SqlDataReader dr;
        string proid;
